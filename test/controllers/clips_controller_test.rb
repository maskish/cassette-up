...
class ClipsControllerTest < ActionController::TestCase
  ...
  test "should create clip" do
    assert_difference('Clip.count') do
      post :create, clip: { crew_id: @clip.crew_id, duration: @clip.duration, title: @clip.title, url: @clip.url }
    end
  ...
  test "should update clip" do
    patch :update, id: @clip, clip: { crew_id: @clip.crew_id, duration: @clip.duration, title: @clip.title, url: @clip.url }
    assert_redirected_to clip_path(assigns(:clip))
  end
